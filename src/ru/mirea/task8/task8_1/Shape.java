...
class Circle extends ru.mirea.task8.task8_1.Shape {
...
class Rectangle extends ru.mirea.task8.task8_1.Shape {
    ...
    public Rectangle(String colour,boolean filled,double width,double length,int x,int y){
        this.colour=colour;
        this.filled=filled;
        this.width=width;
        this.length=length;
...
class Square extends Rectangle {
    ...
    public Square(String colour,boolean filled,double Side,int x, int y){
        this.colour=colour;
        this.filled=filled;
        width=Side;
        length=Side;
